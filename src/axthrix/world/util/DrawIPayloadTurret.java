...
public class DrawIPayloadTurret extends DrawTurret{
    ...
    public DrawIPayloadTurret(boolean drawTurret, String basePrefix){
        this.drawTurret = drawTurret;
        this.basePrefix = basePrefix;
    }

    public DrawIPayloadTurret(boolean drawTurret){
        this.drawTurret = drawTurret;
    }
    ...
    public void load(Block block){
        if(!(block instanceof PayloadTurretType)) throw new ClassCastException("This drawer can only be used on single payload ammo turrets.");
