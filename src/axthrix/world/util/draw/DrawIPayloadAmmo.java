...
import arc.util.*;
import axthrix.world.types.block.defense.AxPayloadAmmoTurret;
...
public class DrawIPayloadAmmo extends RegionPart{
    ...
    public void draw(PartParams partParams){
        AxPayloadAmmoTurret.AxPayloadTurretBuild tb = (AxPayloadAmmoTurret.AxPayloadTurretBuild)parent;
