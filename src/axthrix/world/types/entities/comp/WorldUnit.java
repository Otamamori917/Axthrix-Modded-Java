...
//import axthrix.world.types.unittypes.WorldUnitType;
//import axthrix.world.util.PvPacketHandler;
//import axthrix.world.util.draw.DrawBatchRotate;
...
///**
// * Unit Entity with the ability to build on it
// * @author Siede
// */
...
//                    tiles.set(ix,iy,new Tile(ix,iy, AxthrixEnvironment.crimsonSandDeepFloor, Blocks.air,Blocks.air));
//                }
//        };
...
//
//        if (built && ((player != null && !player.boosting) || (isCommandable() && command().currentCommand() != Command.))) {
