...
public class ItemAcceleratedTurret extends AxItemTurret{
    ...
    public void setBars(){
        ...
        if(acceleratedBonus == 1){
            if(burnsOut){
                addBar("aj-heat", (ItemAcceleratedTurret.ItemAcceleratedTurretBuild entity) -> new Bar(
            ...
            addBar("aj-phases", (ItemAcceleratedTurret.ItemAcceleratedTurretBuild entity) -> new Bar(
