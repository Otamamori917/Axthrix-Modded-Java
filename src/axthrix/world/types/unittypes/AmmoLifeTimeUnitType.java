...
public class AmmoLifeTimeUnitType extends  AxUnitType {
    ...
    public Effect timedOutFx = AxthrixFx.unitBreakdown;
    ...
    public void display(Unit unit, Table table){
        ...
        if(unit.controller() instanceof MiningAi ai && ai.targetItem != null && ai.ore != null && unit.closestCore() != null){
            table.row();
    ...
    public void update(Unit unit){
        ...
        boolean multiplier =(unit.count() > unit.cap() && unit.type.useUnitCap || unit.controller() instanceof  MiningAi ai && ai.inoperable);

        boolean shouldDeplete = (startTime+ ammoDepletionOffset) <= Time.time || unit.controller() instanceof  MiningAi ai && ai.inoperable;
